    ...
    <div className="my-8 w-full max-w-sm mx-auto">
      <div className="flex items-center justify-between">
        ...
        <Dialog>
          ...
          <DialogContent className="flex flex-col items-center text-sm text-center !rounded">
            {post?.author?._id !== user?._id && (
              <Button
                variant="ghost"
                className="cursor-pointer w-fit text-[#ed4956] font-bold rounded"
              >
                Unfollow
              </Button>
            )}
            <Button variant="ghost" className="cursor-pointer w-fit rounded">
              Add to favorites
            </Button>
